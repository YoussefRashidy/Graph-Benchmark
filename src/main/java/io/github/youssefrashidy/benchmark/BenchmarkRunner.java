...
public class BenchmarkRunner {
    ...
    SingleRun runSingleRun(Algorithm algorithm, Graph<Void, Void> graph, Distribution distribution, int v) throws InterruptedException {
    ...
    SingleRun runSingleRun(Algorithm algorithm, Graph<Void, Void> graph, Distribution distribution, Vertex<Void> source, int v) throws InterruptedException {
        return switch (algorithm) {
            case DIJKSTRA -> {
                // warm up
